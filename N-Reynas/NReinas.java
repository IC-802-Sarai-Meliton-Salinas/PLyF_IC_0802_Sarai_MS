...
public class NReinas {
	...
	public static void main(String[] args) {
		...
		do {
			ward = true;
			try {
				tam = Integer.parseInt(JOptionPane.showInputDialog("Ingrese el tama�o del tablero"));
			} catch (NumberFormatException e) {
				// TODO: handle exception
				JOptionPane.showMessageDialog(null, "Error, el dato ingresado es inv�lido", "Error",
